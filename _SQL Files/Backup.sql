BACKUP DATABASE [TwitterManager] TO  DISK = N'E:\Dropbox\z_Backups\Twittermanager3.bck' WITH NOFORMAT, INIT,  NAME = N'TwitterManager-Full Database Backup', SKIP, NOREWIND, NOUNLOAD,  STATS = 10, CHECKSUM
GO
